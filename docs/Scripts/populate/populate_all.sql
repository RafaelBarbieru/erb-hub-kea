...
INSERT INTO `battles`(name, duration, publication_date, lyrics, youtube_link, spotify_link, cover_image, created_at, updated_at) VALUES(
	...
	'https://www.youtube.com/watch?v=kgJMaP4msTs&ab_channel=ERB', 
	'https://open.spotify.com/track/5SLgay95kz6KUq8lwn4RGJ?si=3c0492fa5d234bed', 
	'https://i.ytimg.com/vi/kgJMaP4msTs/maxresdefault.jpg',
    current_timestamp(),
    current_timestamp()
);
INSERT INTO `battles`(name, duration, publication_date, lyrics, youtube_link, spotify_link, cover_image, created_at, updated_at) VALUES(
	...
	'https://www.youtube.com/watch?v=Ver1OZdK2bA&ab_channel=ERB', 
	'https://open.spotify.com/track/21nG2V2EwU6a2JaejWq5UA?si=803c77cd2f5d4d31', 
	'https://i.ytimg.com/vi/Ver1OZdK2bA/maxresdefault.jpg',
    current_timestamp(),
    current_timestamp()
);
INSERT INTO `battles`(name, duration, publication_date, lyrics, youtube_link, spotify_link, cover_image, created_at, updated_at) VALUES(
	...
	'https://www.youtube.com/watch?v=FkGK7bitav0&ab_channel=ERB', 
	'https://open.spotify.com/track/2kgZ69RmZcaKeyC2O5nrYb?si=d6564b42205b45c4', 
	'https://i.ytimg.com/vi/FkGK7bitav0/maxresdefault.jpg',
    current_timestamp(),
    current_timestamp()
);
INSERT INTO `battles`(name, duration, publication_date, lyrics, youtube_link, spotify_link, cover_image, created_at, updated_at) VALUES(
	...
	'https://www.youtube.com/watch?v=v1vXC-vKgKg&ab_channel=ERB', 
	'https://open.spotify.com/track/6qGs58WcucFNfAsXpBrGJ4?si=4d7e657152544c21', 
	'https://images.genius.com/1f54f9dd5ebfa330008b4a9e497786fc.1000x563x1.jpg',
    current_timestamp(),
    current_timestamp()
);
INSERT INTO `battles`(name, duration, publication_date, lyrics, youtube_link, spotify_link, cover_image, created_at, updated_at) VALUES(
	...
	'https://www.youtube.com/watch?v=R2WxaeIJcqY&ab_channel=ERB', 
	'https://open.spotify.com/track/1y6U28IyN1OTKz4JJYOtiH?si=6f9bc33756cc4613', 
	'https://i.ytimg.com/vi/R2WxaeIJcqY/maxresdefault.jpg',
    current_timestamp(),
    current_timestamp()
);
...
INSERT INTO `characters`(name, description, image, created_at, updated_at) VALUES(
	...
	'https://static.wikia.nocookie.net/epicrapbattlesofhistory/images/e/ee/Ragnar_Lodbrok_Title_Card.png/revision/latest/scale-to-width-down/1920?cb=20210614191345',
	current_timestamp(),
	current_timestamp()
);
INSERT INTO `characters`(name, description, image, created_at, updated_at) VALUES(
	...
	'https://static.wikia.nocookie.net/epicrapbattlesofhistory/images/a/a3/Richard_the_Lionheart_Title_Card.png/revision/latest/scale-to-width-down/1920?cb=20210614191746',
	current_timestamp(),
	current_timestamp()
);
INSERT INTO `characters`(name, description, image, created_at, updated_at) VALUES(
	...
	'https://static.wikia.nocookie.net/epicrapbattlesofhistory/images/d/d7/Harry_Potter_Title_Card.png/revision/latest/scale-to-width-down/1920?cb=20201205215024',
	current_timestamp(),
	current_timestamp()
);
INSERT INTO `characters`(name, description, image, created_at, updated_at) VALUES(
	'Luke Skywalker',
	"Luke Skywalker is a fictional character and the protagonist of the original film trilogy of the Star Wars franchise created by George Lucas. Portrayed by Mark Hamill, Luke first appeared in Star Wars (1977),[a] and he returned in The Empire Strikes Back (1980) and Return of the Jedi (1983). Three decades later, Hamill returned as Luke in the Star Wars sequel trilogy, appearing in all three films: The Force Awakens (2015), The Last Jedi (2017), and The Rise of Skywalker (2019).",
	'https://static.wikia.nocookie.net/epicrapbattlesofhistory/images/c/c3/Luke_Skywalker_Title_Card.png/revision/latest/scale-to-width-down/1920?cb=20201207045842',
	current_timestamp(),
	current_timestamp()
);
INSERT INTO `characters`(name, description, image, created_at, updated_at) VALUES(
	'Donald Trump',
	"Donald John Trump (born June 14, 1946) is an American politician, media personality, and businessman who served as the 45th president of the United States from 2017 to 2021. Born and raised in Queens, New York City, Trump graduated from the University of Pennsylvania with a bachelor's degree in 1968. He became the president of his father Fred Trump's real estate business in 1971 and renamed it The Trump Organization. Trump expanded the company's operations to building and renovating skyscrapers, hotels, casinos, and golf courses.",
	'https://static.wikia.nocookie.net/epicrapbattlesofhistory/images/9/9d/Donald_Trump_Title_Card_2.png/revision/latest/scale-to-width-down/1920?cb=20161028135025',
	current_timestamp(),
	current_timestamp()
);
INSERT INTO `characters`(name, description, image, created_at, updated_at) VALUES(
	'Joe Biden',
	"Joseph Robinette Biden Jr. (November 20, 1942) is an American politician who is the 46th and current president of the United States. A member of the Democratic Party, he served as the 47th vice president from 2009 to 2017 under Barack Obama and represented Delaware in the United States Senate from 1973 to 2009.",
	'https://static.wikia.nocookie.net/epicrapbattlesofhistory/images/4/4c/Joe_Biden_Title_Card.png/revision/latest/scale-to-width-down/1920?cb=20201029064010',
	current_timestamp(),
	current_timestamp()
);
INSERT INTO `characters`(name, description, image, created_at, updated_at) VALUES(
	...
	'https://static.wikia.nocookie.net/epicrapbattlesofhistory/images/a/ad/Thanos_Title_Card.png/revision/latest/scale-to-width-down/1920?cb=20191220035512',
	current_timestamp(),
	current_timestamp()
);
INSERT INTO `characters`(name, description, image, created_at, updated_at) VALUES(
	...
	'https://static.wikia.nocookie.net/epicrapbattlesofhistory/images/b/b4/J._Robert_Oppenheimer_Title_Card.png/revision/latest/scale-to-width-down/1920?cb=20191219164950',
	current_timestamp(),
	current_timestamp()
);
INSERT INTO `characters`(name, description, image, created_at, updated_at) VALUES(
	...
	'https://static.wikia.nocookie.net/epicrapbattlesofhistory/images/9/9a/The_Joker_Title_Card.png/revision/latest/scale-to-width-down/1920?cb=20191127130624',
	current_timestamp(),
	current_timestamp()
);
INSERT INTO `characters`(name, description, image, created_at, updated_at) VALUES(
	...
	'https://static.wikia.nocookie.net/epicrapbattlesofhistory/images/a/a7/Pennywise_Title_Card.png/revision/latest/scale-to-width-down/1920?cb=20191124062219',
	current_timestamp(),
	current_timestamp()
);
...
INSERT INTO `actors`(name, alias, description, image, created_at, updated_at) VALUES(
    ...
    'https://static.wikia.nocookie.net/epicrapbattlesofhistory/images/f/fd/Nice_Peter_In_Battle_2.png/revision/latest/scale-to-width-down/480?cb=20170110070313',
    current_timestamp(),
    current_timestamp()
);
INSERT INTO `actors`(name, alias, description, image, created_at, updated_at) VALUES(
    ...
    'https://static.wikia.nocookie.net/epicrapbattlesofhistory/images/6/60/EpicLLOYD_In_Battle_2.png/revision/latest/scale-to-width-down/480?cb=20170110070432',
    current_timestamp(),
    current_timestamp()
);
INSERT INTO `actors`(name, alias, description, image, created_at, updated_at) VALUES(
    ...
    'https://i1.sndcdn.com/avatars-000062706540-t0hsez-t500x500.jpg',
    current_timestamp(),
    current_timestamp()
);
...
INSERT INTO `battles_characters`(battles_id, characters_id) VALUES(1, 1);
INSERT INTO `battles_characters`(battles_id, characters_id) VALUES(1, 2);
INSERT INTO `battles_characters`(battles_id, characters_id) VALUES(2, 3);
INSERT INTO `battles_characters`(battles_id, characters_id) VALUES(2, 4);
INSERT INTO `battles_characters`(battles_id, characters_id) VALUES(3, 5);
INSERT INTO `battles_characters`(battles_id, characters_id) VALUES(3, 6);
INSERT INTO `battles_characters`(battles_id, characters_id) VALUES(4, 7);
INSERT INTO `battles_characters`(battles_id, characters_id) VALUES(4, 8);
INSERT INTO `battles_characters`(battles_id, characters_id) VALUES(5, 9);
INSERT INTO `battles_characters`(battles_id, characters_id) VALUES(5, 10);

-- POPULATING ACTORS_CHARACTERS
INSERT INTO `actors_characters`(actors_id, characters_id) VALUES(1, 2);
INSERT INTO `actors_characters`(actors_id, characters_id) VALUES(1, 4);
INSERT INTO `actors_characters`(actors_id, characters_id) VALUES(1, 6);
INSERT INTO `actors_characters`(actors_id, characters_id) VALUES(1, 8);
INSERT INTO `actors_characters`(actors_id, characters_id) VALUES(1, 9);
INSERT INTO `actors_characters`(actors_id, characters_id) VALUES(2, 1);
INSERT INTO `actors_characters`(actors_id, characters_id) VALUES(2, 5);
INSERT INTO `actors_characters`(actors_id, characters_id) VALUES(2, 7);
INSERT INTO `actors_characters`(actors_id, characters_id) VALUES(2, 10);
INSERT INTO `actors_characters`(actors_id, characters_id) VALUES(3, 3);

-- POPULATING ACTORS_SOCIAL_MEDIA
-- Nice Peter - YouTube
INSERT INTO `actors_social_media`(link, actors_id, social_media_id) VALUES('https://www.youtube.com/user/nicepeter', 1, 1);
-- Nice Peter - Twitter
INSERT INTO `actors_social_media`(link, actors_id, social_media_id) VALUES('https://twitter.com/nicepeter', 1, 2);
-- Nice Peter - Spotify
INSERT INTO `actors_social_media`(link, actors_id, social_media_id) VALUES('https://open.spotify.com/artist/5qcFSzd44Md3Ub2tNngTte?si=2ve2LlSUT_Wqup7lCXQspA&dl_branch=1', 1, 3);
-- EpicLLOYD - YouTube
INSERT INTO `actors_social_media`(link, actors_id, social_media_id) VALUES('https://www.youtube.com/user/EPICLLOYD', 2, 1);
-- EpicLLOYD - Twitter
INSERT INTO `actors_social_media`(link, actors_id, social_media_id) VALUES('https://twitter.com/TheEpicLLOYD', 2, 2);
-- EpicLLOYD - Spotify
INSERT INTO `actors_social_media`(link, actors_id, social_media_id) VALUES('https://open.spotify.com/artist/62sK16KPm7eBSUDWcINUd3?si=qeWqat1ORIuWnLqQzfQ44A&dl_branch=1', 2, 3);
-- Boyinaband - YouTube
INSERT INTO `actors_social_media`(link, actors_id, social_media_id) VALUES('https://www.youtube.com/c/boyinaband', 3, 1);
-- Boyinaband - Twitter
INSERT INTO `actors_social_media`(link, actors_id, social_media_id) VALUES('https://twitter.com/davepbrown', 3, 2);
-- Boyinaband - Spotify
INSERT INTO `actors_social_media`(link, actors_id, social_media_id) VALUES('https://open.spotify.com/artist/7kfzadZaOgR90Tp8OYH5gM?si=DUhsSR1RQDaDVQd4TaIaHA&dl_branch=1', 3, 3);
